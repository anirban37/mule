...
public class DefaultExtensionManagerTestCase extends AbstractMuleTestCase {
  ...
  public void before() throws InitialisationException, RegistrationException {
    ...
    when(configurationProperties.resolveBooleanProperty(anyString())).thenReturn(Optional.of(true));
    muleContext = mockContextWithServices(singletonMap(ConfigurationProperties.class, configurationProperties));
